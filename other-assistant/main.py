...
class Assistant:
    ...
    def stop(self):
        self.speak("Goodbye, Have a nice day. See you again !!!")
    ...
    def get_user_voice(self):
        for i in range(3):
            ...
            if text:
                ...
                self.speak("I can hear you clearly, can you repeat that again please ?")
        time.sleep(1)
        self.stop()
        return 0
...
if __name__ == "__main__":
    ...
    while(True):
        ...
        if user_input.lower() != "goodbye":
            ...
            # print("TRANSLATE_TEXT: ", translated_text)
            # my_assistant.detect_intent_by_texts(PROJECT_ID, SESSION_ID, translated_text, LANGUAGE_CODE)
            my_assistant.detect_intent_by_texts(PROJECT_ID, SESSION_ID, user_input, LANGUAGE_CODE)
        else:
            break
        # user_voice = my_assistant.get_user_voice()
        # if user_voice.lower() != "goodbye":
        #     my_assistant.detect_intent_by_texts(PROJECT_ID, SESSION_ID, user_voice, LANGUAGE_CODE)
        # else:
        #     break
